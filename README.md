# Quectel USB Drivers — Linux 6.12.x

Out-of-tree and in-kernel-patch Quectel cellular modem drivers for Linux kernel **6.12.x**.
...
> **Note:** Not all products above are new in this branch — the in-kernel patches add the ones missing from kernel 6.12.x mainline. See `patches/*.patch` for the exact delta.
...
- Patches are generated against vanilla kernel 6.12.x sources. If your kernel is already patched (e.g., vendor BSP), you may need to resolve conflicts manually.
