# Quectel USB Drivers — Linux 5.15.x

Out-of-tree and in-kernel-patch Quectel cellular modem drivers for Linux kernel **5.15.x**.
...
> **Note:** Not all products above are new in this branch — the in-kernel patches add the ones missing from kernel 5.15.x mainline. See `patches/*.patch` for the exact delta.
...
git clone -b v5.15 https://github.com/bacnh85/Quectel_Linux_USB_Driver.git
...
- Patches are generated against vanilla kernel 5.15.x sources. If your kernel is already patched (e.g., vendor BSP), you may need to resolve conflicts manually.
