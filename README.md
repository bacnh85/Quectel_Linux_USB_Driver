# Quectel USB Drivers — Linux 6.1.x

Out-of-tree and in-kernel-patch Quectel cellular modem drivers for Linux kernel **6.1.x**.
...
> **Note:** Not all products above are new in this branch — the in-kernel patches add the ones missing from kernel 6.1.x mainline. See `patches/*.patch` for the exact delta.
...
git clone -b v6.1 https://github.com/bacnh85/Quectel_Linux_USB_Driver.git
...
- Patches are generated against vanilla kernel 6.1.x sources. If your kernel is already patched (e.g., vendor BSP), you may need to resolve conflicts manually.
